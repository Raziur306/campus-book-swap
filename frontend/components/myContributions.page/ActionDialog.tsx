...
import { DeleteBookModalPropsType } from "@/types";
import React, { useState } from "react";

const ActionDialog = ({
  handleModalClose,
  bookId,
}: DeleteBookModalPropsType) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/delete-book/${bookId}`,
        {
          method: "DELETE",
          headers: {
            ...
            {!isLoading && !isSuccess && (
              <ActionModalContentWrapper>
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-600 ">
                  Please ensure careful consideration before making a decision,
                  as changes are irreversible, and modifications are not allowed
                  once a choice is submitted. Take your time and be certain of
                  your selection.
                </h3>
