...
const ButtonContainer = styled.div`
  ...
  --color-text: #ffffff;
  --color-background: #314f8c;
  --color-outline: #31508c80;
...
const NextButton: React.FC<CTAProps> = ({ children, onClick, disabled }) => {
  return (
    <ButtonContainer>
      <StyledButton onClick={onClick} disabled={disabled}>
        <span className="btn-title">{children || "NEXT"}</span>
